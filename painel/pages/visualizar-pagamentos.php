...
?>  
    ...
    <div class="gerar-pdf">
        <a target="_blank" href="<?php echo INCLUDE_PATH_PAINEL ?>gerar-pdf?pagamento=pendentes">Gerar PDF</a>
    </div>
    ...
    <div class="gerar-pdf">
        <a target="_blank" href="<?php echo INCLUDE_PATH_PAINEL ?>gerar-pdf?pagamento=concluidos">Gerar PDF</a>
    </div>
